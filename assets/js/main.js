    ...
    ac: [
      {
        ...
        reflexive: {
          ...
          projet: { titre: "Mémo de Révision : CAN, CNA et Échantillonnage", lien: "Memo_Revision_CAN_CNA_Echantillonnage.pdf", desc: "Synthèse des concepts fondamentaux, formules et méthodes de résolution sur le traitement numérique du signal." }
        }
      },
      {
        code: "AC11.02",
    ...
    ac: [
      ...
      },
      {
        ...
        reflexive: {
          ...
          projet: { titre: "Quiz R&T - 60 Questions", lien: "Quiz R&T - 60 Questions (Sans Réponses).pdf", desc: "Questionnaire complet couvrant le déploiement d'un serveur Asterisk, la QoS, la VoIP, le réseau RTC et les Modems." }
        }
      },
      {
        code: "AC12.04",
    ...
    ac: [
      ...
      },
      {
        ...
        reflexive: {
          ...
          projet: { titre: "Guide Méthodologique SQL CTP", lien: "Guide_Methodologique_SQL_CTP.pdf", desc: "Framework de résolution pas-à-pas et requêtes (DDL, DML, Fonctions Window) applicable pour les bases de données." }
        }
      },
      {
        code: "AC13.04",
